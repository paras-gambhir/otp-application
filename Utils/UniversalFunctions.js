   ...
   // console.trace('ERROR OCCURED ', data);
    if (typeof data == 'object' && data.hasOwnProperty('statusCode') && data.hasOwnProperty('customMessage')) {
      ...
      //  console.log(errorToSend);
        errorToSend.output.payload = {error : data.type,error_description: data.customMessage};
        return errorToSend;
    } else {
       // console.log("else condt")
        var errorToSend = '';
...
var failActionFunction = function (request, reply, source, error) {
    ...
    console.log("......................fail function...................",request.payload);
...
function generateToken(text,callback) {
